...
public class SaveRelationServlet  extends javax.servlet.http.HttpServlet {
    ...
    public void doPost(HttpServletRequest req, HttpServletResponse resp) throws IOException {
        ...
        relation = new Entity("Relation", email + title + contentType);
        relation.setProperty("Email", email);
        relation.setProperty("Title", title);
        relation.setProperty("ContentType", contentType);
